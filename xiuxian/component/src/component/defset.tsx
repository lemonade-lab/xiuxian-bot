    ...
    <div id="app" className="defset">
      ...
      <div className="Config-body">
        <div className="Config-body-title-re">
          <div className="Config-body-font">突破冷却: {data.CD_Level_up}m</div>
          <div className="Config-body-font">
            破体冷却: {data.CD_LevelMax_up}m
          </div>
          <div className="Config-body-font">道宣冷却: {data.CD_Autograph}m</div>
          <div className="Config-body-font">改名冷却: {data.CD_Name}m</div>
          <div className="Config-body-font">重生冷却: {data.CD_Reborn}m</div>
          <div className="Config-body-font">赠送冷却: {data.CD_Transfer}m</div>
          <div className="Config-body-font">攻击冷却: {data.CD_Attack}m</div>
          ...
          <div className="Config-body-font">双修冷却: {data.CD_Ambiguous}m</div>
          <div className="Config-body-font">比斗冷却: {data.CD_Battle}m</div>
          <div className="Config-body-font">
            传功冷却: {data.CD_transmissionPower}m
          </div>
        </div>
        <div className="Config-body-title-re">
          <div className="Config-body-font">闭关倍率: {data.biguan_size}</div>
