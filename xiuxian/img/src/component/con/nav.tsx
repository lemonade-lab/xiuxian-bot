    ...
    <div className="p-4 text-white">
      ...
      <div className="bg-[var(--bg-color)]  mt-10 nav-box p-4 pt-4 pb-8 rounded-t-xl flex justify-between relative">
        ...
        <div className="flex-1 m-auto relative text-center">
          ...
          <div
            className="absolute nav-box-uidwhitespace-nowrap overflow-hidden overflow-ellipsis   text-center w-full left-0 text-[#ffffffe6] font-bold rounded-xl"
            style={{ background: color }}
          >
            {UID}
          </div>

          <div className="absolute nav-box-uidwhitespace-nowrap overflow-hidden overflow-ellipsis   text-center w-full left-0 bottom-[-44px] text-[#ffffffe6] font-bold rounded-xl">
