import { hash, importPath, Puppeteer, ABuffer, Controllers, APlugin, createApp } from 'alemonjs';
...
function App$b({ data }) {
    ...
    return (React.createElement("html", null,
        React.createElement("head", null,
            React.createElement("link", { rel: "stylesheet", href: "../css/root.css" }),
            React.createElement("link", { rel: "stylesheet", href: "../css/bag.css" })),
        React.createElement("body", null,
            React.createElement("div", { id: "app", className: "user" },
                ...
                React.createElement("div", { className: "user_top" },
                    React.createElement("div", { className: "user_top_left" },
                        React.createElement("div", { className: "user_top_right_font0 font_control Horizontal_grid" }, UID),
                        React.createElement("div", { className: "user_top_right_font1 font_control Horizontal_grid" },
                            "\u9053\u53F7: ",
                            data.name),
                        React.createElement("div", { className: "user_top_right_font font_control Horizontal_grid" },
                            "\u7B49\u7EA7: ",
                            data.bag_grade),
                        React.createElement("div", { className: "user_top_right_font2 font_control Horizontal_grid", style: { borderBottomRightRadius: '0px' } },
                            "\u683C\u5B50: ",
                            data.length,
                            "/",
                            data.bag_grade * 10)),
                    React.createElement("div", { className: "user_top_right" },
                        React.createElement("div", { className: "user_top_img_bottom" },
                            React.createElement("img", { className: "user_top_img", src: data.avatar, alt: "User Avatar" })))),
                React.createElement("div", { className: "user_bottom1" },
                    React.createElement("div", { className: "use_data" }, data.bag.map((item, index) => (React.createElement("div", { key: index },
                        React.createElement("div", { className: "user_top_right_font0 font_control Horizontal_grid" }, item['good.name']),
                        React.createElement("div", { className: "user_top_right_font1 font_control lattice" },
                            ...
                            React.createElement("div", null,
                                ...
                                item['good.blood'],
                                "%")),
                        React.createElement("div", { className: "user_top_right_font font_control lattice" },
                            React.createElement("div", null,
                                "\u5929\u8D4B: ",
                                item['good.size'],
                                "%"),
                        ...
                        React.createElement("div", { className: "user_top_right_font1 font_control lattice" },
                            ...
                            React.createElement("div", null,
                                ...
                                item['good.addition'] === 'boolere_covery' && (React.createElement("span", null, " % "))),
                            React.createElement("div", null, "\u4E94\u884C: ???")),
                        React.createElement("div", { className: "user_top_right_font2 font_control lattice", style: { marginBottom: '5px' } },
                            React.createElement("div", null,
                                "\u7B49\u7EA7: ",
                                item['good.grade']),
                            React.createElement("div", null,
...
function App$a({ data }) {
    return (React.createElement("html", null,
        React.createElement("head", null,
            React.createElement("link", { rel: "stylesheet", href: "../css/root.css" }),
            React.createElement("link", { rel: "stylesheet", href: "../css/defset.css" })),
        React.createElement("body", null,
            React.createElement("div", { id: "app", className: "defset" },
                React.createElement("div", { className: "defset-c" }),
                React.createElement("div", { className: "Config-body" },
                    React.createElement("div", { className: "Config-body-title-re" },
                        React.createElement("div", { className: "Config-body-font" },
                            "\u7A81\u7834\u51B7\u5374: ",
                            data.CD_Level_up,
                            "m"),
                        React.createElement("div", { className: "Config-body-font" },
...
function App$9({ data }) {
    ...
    return (React.createElement("html", null,
        React.createElement("head", null,
            React.createElement("link", { rel: "stylesheet", href: "../css/root.css" }),
            React.createElement("link", { rel: "stylesheet", href: "../css/equipment.css" })),
        React.createElement("body", null,
            React.createElement("div", { id: "app", className: "user" },
                React.createElement("div", { style: { height: '30px' } }),
                React.createElement("div", { className: "user_top" },
                    React.createElement("div", { className: "user_top_left" },
                        React.createElement("div", { className: "user_top_right_font0 font_control Horizontal_grid", style: { borderTopRightRadius: '0px' } }, UID),
                        React.createElement("div", { className: "user_top_right_font font_control Horizontal_grid", style: {
                                display: 'grid',
                        ...
                        React.createElement("div", { className: "user_top_right_font1 font_control Horizontal_grid", style: {
                                display: 'grid',
                                gridTemplateColumns: 'repeat(2, 50%)'
                            } },
                            React.createElement("div", { className: "font" },
                    ...
                    React.createElement("div", { className: "user_top_right" },
                        React.createElement("div", { className: "user_top_img_bottom" },
                            React.createElement("img", { className: "user_top_img", src: data.avatar })))),
                React.createElement("div", { className: "user_bottom1" },
                    React.createElement("div", { className: "use_data" }, data.fate.map(item => (React.createElement("div", { key: item.name },
                        React.createElement("div", { className: "user_top_right_font0 font_control Horizontal_grid", style: { backgroundColor: 'rgb(61 18 12 / 84%)' } },
                            item.name,
                            "[",
                            item.grade,
                            "]"),
                        React.createElement("div", { className: "user_top_right_font1 font_control lattice", style: { backgroundColor: 'rgb(109 75 47 / 56%)' } },
                            React.createElement("div", { className: "font" },
                                "\u653B\u51FB : ",
                                item.attack,
                                "%"),
                            ...
                            React.createElement("div", { className: "font" },
                                ...
                                item.blood,
                                "%")),
                        React.createElement("div", { className: "user_top_right_font2 font_control lattice", style: {
                                marginBottom: '5px',
                            ...
                            React.createElement("div", { className: "font" },
                                ...
                                item.speed))))))),
                React.createElement("div", { className: "user_bottom1" },
                    React.createElement("div", { className: "use_data" }, data.equipment.map(item => (React.createElement("div", { key: item['good.name'] },
                        React.createElement("div", { className: "user_top_right_font0 font_control Horizontal_grid" }, item['good.name']),
                        React.createElement("div", { className: "user_top_right_font1 font_control lattice" },
                            React.createElement("div", { className: "font" },
                                "\u653B\u51FB : ",
...
function App$8({ data }) {
    return (React.createElement("html", null,
        React.createElement("head", null,
            React.createElement("link", { rel: "stylesheet", href: "../css/root.css" }),
            React.createElement("link", { rel: "stylesheet", href: "../css/help.css" })),
        React.createElement("body", null,
            React.createElement("div", { id: "app", className: "help" },
                React.createElement("div", { style: { height: '350px' } }),
                data.map(val => (React.createElement("div", { key: val.group, className: "cont-box" },
                    React.createElement("div", { className: "help-group" }, val.group),
                    React.createElement("div", { className: "help-table" },
                        React.createElement("div", { className: "tr" }, val.list.map(item => (React.createElement("div", { key: item.title, className: "td" },
                            React.createElement("span", { className: `help-icon help-icon-${item.icon}` }),
                ...
                React.createElement("div", { className: "copyright" },
                    React.createElement("span", { className: "version" }, 'https://alemonjs.com/')),
                React.createElement("div", { className: "copyright" },
...
function App$7({ data }) {
    return (React.createElement("head", null,
        React.createElement("head", null,
            React.createElement("link", { rel: "stylesheet", href: "../css/root.css" }),
            React.createElement("link", { rel: "stylesheet", href: "../css/kill.css" })),
        React.createElement("body", null,
            React.createElement("div", { id: "app", className: "user" }, data.map(item => (React.createElement("div", { key: item.UID, style: { display: 'grid' } },
                React.createElement("div", { className: "user_top" },
                    React.createElement("div", { className: "user_top_left" },
                        React.createElement("div", { className: "user_top_right_font0 font_control Horizontal_grid", style: { padding: '5px' } }, isNaN(Number(item.UID)) ? hash(item.UID) : item.UID),
                        React.createElement("div", { className: "user_top_right_font1 font_control Horizontal_grid", style: { padding: '5px' } },
                            "\u9053\u53F7: ",
                            item.lifeName),
                        React.createElement("div", { className: "user_top_right_font2 font_control Horizontal_grid", style: { padding: '5px' } },
                            "\u715E\u6C14: ",
                            item.prestige),
                        React.createElement("div", { className: "user_top_right_font1 font_control Horizontal_grid", style: { padding: '5px' } },
                            "\u6218\u529B: ",
                    ...
                    React.createElement("div", { className: "user_top_right" },
                        React.createElement("div", { className: "user_top_img_bottom" },
                            React.createElement("img", { className: "user_top_img", src: item.user_avatar })))),
                React.createElement("div", { className: "user_bottom1" },
                    React.createElement("div", { className: "use_data" },
                        React.createElement("div", { className: "user_top_right_font0 font_control Horizontal_grid" }, '[修心道宣]'),
                        React.createElement("div", { className: "user_top_right_font2 font_control Horizontal_grid" }, item.autograph))))))))));
}
...
function App$6({ data }) {
    return (React.createElement("html", null,
        React.createElement("head", null,
            React.createElement("link", { rel: "stylesheet", href: "../css/root.css" }),
            React.createElement("link", { rel: "stylesheet", href: "../css/list.css" })),
        React.createElement("body", null,
            React.createElement("div", { id: "app", className: "user" }, data.map(item => (React.createElement("div", { key: item.UID, style: { display: 'grid' } },
                React.createElement("div", { className: "user_top" },
                    React.createElement("div", { className: "user_top_left" },
                    ...
                    React.createElement("div", { className: "user_top_right" },
                        React.createElement("div", { className: "user_top_img_bottom" },
                            React.createElement("img", { className: "user_top_img", src: item.user_avatar, alt: "User Avatar" })))),
                React.createElement("div", { className: "user_bottom1" },
                    React.createElement("div", { className: "use_data" },
                        React.createElement("div", { className: "user_top_right_font0 font_control Horizontal_grid" }, '[修心道宣]'),
                        React.createElement("div", { className: "user_top_right_font2 font_control Horizontal_grid" }, item.autograph))))))))));
...
function App$5({ data }) {
    ...
    return (React.createElement("html", null,
        React.createElement("head", null,
            React.createElement("link", { rel: "stylesheet", href: "../css/root.css" }),
            React.createElement("link", { rel: "stylesheet", href: "../css/ring.css" })),
        React.createElement("body", null,
            React.createElement("div", { id: "app", className: "user" },
                React.createElement("div", { style: { height: '30px' } }),
                React.createElement("div", { className: "user_top" },
                    ...
                    React.createElement("div", { className: "user_top_right" },
                        React.createElement("div", { className: "user_top_img_bottom" },
                            React.createElement("img", { className: "user_top_img", src: data.avatar, alt: "User Avatar" })))),
                React.createElement("div", { className: "user_bottom1" },
                    React.createElement("div", { className: "use_data" }, data.bag.map(item => (React.createElement("div", { key: item.id },
                        React.createElement("div", { className: "user_top_right_font0 font_control Horizontal_grid" }, item['good.name']),
                        React.createElement("div", { className: "user_top_right_font1 font_control lattice" },
                            React.createElement("div", null,
                                "\u653B\u51FB: ",
...
function App$4({ data }) {
    ...
    return (React.createElement("html", null,
        React.createElement("head", null,
            React.createElement("link", { rel: "stylesheet", href: "../css/root.css" }),
            React.createElement("link", { rel: "stylesheet", href: "../css/skills.css" })),
        React.createElement("body", null,
            React.createElement("div", { id: "app", className: "user" },
                React.createElement("div", { style: { height: '30px' } }),
                React.createElement("div", { className: "user_top" },
                    React.createElement("div", { className: "user_top_left" },
                        ...
                        React.createElement("div", { className: "user_top_right_font1 font_control Horizontal_grid" },
                            "\u7075\u6839: ",
                            data.linggenName),
                        React.createElement("div", { className: "user_top_right_font2 font_control Horizontal_grid" },
                            "\u5929\u8D4B: ",
                            data.talentsize)),
                    React.createElement("div", { className: "user_top_right" },
                        React.createElement("div", { className: "user_top_img_bottom" },
                            React.createElement("img", { className: "user_top_img", src: data.avatar, alt: "User Avatar" })))),
                React.createElement("div", { className: "user_bottom1" },
                    React.createElement("div", { className: "use_data" }, data.skills.map(item => (React.createElement("div", { key: item.id },
                        React.createElement("div", { className: "user_top_right_font0 font_control Horizontal_grid" }, item['good.name']),
                        React.createElement("div", { className: "user_top_right_font2 font_control lattice", style: { marginBottom: '5px' } },
                            React.createElement("div", null,
                                "\u5929\u8D4B: ",
...
function App$3({ data }) {
    return (React.createElement("html", null,
        ...
        React.createElement("body", null,
            React.createElement("div", { id: "app", className: "user" }, data.map(item => (React.createElement("div", { key: item.id },
                React.createElement("div", { style: { display: 'grid' } },
                    React.createElement("div", { className: "user_top" },
                        ...
                        React.createElement("div", { className: "user_top_right" },
                            React.createElement("div", { className: "user_top_img_bottom" },
                                React.createElement("img", { className: "user_top_img", src: item.avatar, alt: "User Avatar" }))))),
                React.createElement("div", { className: "user_bottom1" },
                    React.createElement("div", { className: "use_data" },
                        React.createElement("div", { className: "user_top_right_font0 font_control Horizontal_grid" }, '[修心道宣]'),
                        React.createElement("div", { className: "user_top_right_font2 font_control Horizontal_grid" }, item.autograph))))))))));
...
function App$2() {
    return (React.createElement("div", { className: "nav-menu" },
        React.createElement("span", { className: "nav-menu-title" }, "\u51E1\u4EBA\u4FEE\u4ED9"),
        React.createElement("span", { className: "menu-button" }, "#\u518D\u5165\u4ED9\u9014"),
        React.createElement("span", { className: "menu-button" }, "#\u66F4\u6362\u4E3B\u9898"),
        React.createElement("span", { className: "menu-button" }, "#\u66F4\u6539\u9053\u53F7+\u5B57\u7B26")));
}
...
function App$1({ data }) {
    ...
    return (React.createElement("div", { className: "nav" },
        ...
        React.createElement("div", { className: "nav-box" },
            React.createElement("span", { className: "menu-button-flat" }, "#\u4E2A\u4EBA\u4FE1\u606F"),
            React.createElement("span", { className: "nav-talent", style: {
                    filter: data.talent_show ? 'initial' : 'grayscale(100%)'
                } },
                React.createElement("span", { className: "nav-talent-item nav-talent-item-1", style: {
                        filter: show(1, 6)
                    } }, "\u91D1"),
                React.createElement("span", { className: "nav-talent-item nav-talent-item-2", style: {
                        filter: show(2, 7)
                    } }, "\u6728"),
                React.createElement("span", { className: "nav-talent-item nav-talent-item-3", style: {
                        filter: show(3, 8)
                    } }, "\u6C34"),
                React.createElement("span", { className: "nav-talent-item nav-talent-item-4", style: {
                        filter: show(4, 9)
                    } }, "\u706B"),
                React.createElement("span", { className: "nav-talent-item nav-talent-item-5", style: {
                        filter: show(5, 10)
                    } }, "\u571F")),
            React.createElement("div", { className: "nav-box-flex" },
                React.createElement("div", { className: "nav-box-item" },
                    React.createElement("img", { className: "nav-box-item-img", src: _('svg/name.svg') }),
                    React.createElement("span", null, data.name)),
                React.createElement("div", { className: "nav-box-item" },
                    React.createElement("img", { className: "nav-box-item-img", src: _('svg/level.svg') }),
            ...
            React.createElement("div", { className: "nav-box-flex nav-box-avatar" },
                React.createElement("img", { className: "nav-box-img", src: data.avatar }),
                React.createElement("div", { className: "nav-box-uid", style: {
                        background: color
                    } }, UID),
                React.createElement("span", { className: "nav-box-blool" }, `${data.battle_blood_now}/${data.battle_blood_limit}-${pro}%`)),
            React.createElement("div", { className: "nav-box-flex" },
                React.createElement("div", { className: "nav-box-item" },
                    React.createElement("img", { className: "nav-box-item-img", src: _('svg/power.svg') }),
                    React.createElement("span", null, data.battle_power)),
                React.createElement("div", { className: "nav-box-item" },
                    React.createElement("img", { className: "nav-box-item-img", src: _('svg/efficiency.svg') }),
...
function App({ data }) {
    return (React.createElement("html", null,
        React.createElement("head", null,
            React.createElement("link", { rel: "stylesheet", href: _('css/new-root.css') }),
            React.createElement("link", { rel: "stylesheet", href: _(`css/root-${data.theme}.css`) }),
            React.createElement("link", { rel: "stylesheet", href: _(`css/new-nav.css`) }),
            React.createElement("link", { rel: "stylesheet", href: _(`css/new-message.css`) })),
        React.createElement("body", null,
            React.createElement("div", { id: "root" },
                React.createElement(App$1, { data: data }),
                React.createElement("div", { className: "autograph" },
                    React.createElement("div", { className: "autograph-box" },
                        React.createElement("span", null, data.autograph),
                        React.createElement("span", { className: "menu-button-flat" }, "#\u66F4\u6539\u9053\u5BA3+\u5B57\u7B26"))),
                React.createElement("div", { className: "level" },
                    React.createElement("div", { className: "level-box" },
                        React.createElement("span", { className: "menu-button-flat" }, "#\u88C5\u5907\u4FE1\u606F"),
                        React.createElement("div", { className: "level-box-item" },
                            "\u58F0\u671B: ",
                ...
                data.skills.length > 0 && (React.createElement("div", { className: "kills" },
                    React.createElement("div", { className: "kills-box" },
                        data.skills.map((item, index) => (React.createElement("span", { key: item['good.name'] },
                            "\u300A",
                            item['good.name'],
                            "\u300B "))),
                        React.createElement("span", { className: "menu-button-flat" }, "#\u529F\u6CD5\u4FE1\u606F")))),
                React.createElement("div", { className: "box-help" },
                    React.createElement("div", { className: "box-help-box" },
                        React.createElement("span", { className: "menu-button-flat" }, "#\u4FEE\u4ED9\u5E2E\u52A9"),
                        React.createElement("span", { className: "menu-button" }, "#\u7A81\u7834"),
                        React.createElement("span", { className: "menu-button" }, "#\u95ED\u5173"),
                        React.createElement("span", { className: "menu-button" }, "#\u51FA\u5173"),
                        React.createElement("span", { className: "menu-button" }, "#\u50A8\u7269\u888B"),
                        React.createElement("span", { className: "menu-button" }, "#\u4E07\u5B9D\u697C"),
                        React.createElement("span", { className: "menu-button" }, "#\u6253\u52AB@\u9053\u53CB")))))));
}
...
class Component {
    ...
    async message(data, uid) {
        return this.puppeteer.toFile(this.create(React.createElement(App, { data: data }), 'message', `${uid}.html`));
    }
}
var ImageComponent = new Component(join(cwd, 'public', 'cache'));
function getDefsetComponent(data) {
    return p.toFile(create$4(React.createElement(App$a, { data: data }), 'defset', 'defset'));
}
function getHelpComponent(data) {
    return p.toFile(create$4(React.createElement(App$8, { data: data }), 'help', 'help'));
}
function getKillComponent(data, uid) {
    return p.toFile(create$4(React.createElement(App$7, { data: data }), 'kill', uid));
}
function getListComponent(data, uid) {
    return p.toFile(create$4(React.createElement(App$6, { data: data }), 'list', uid));
}
function getBagComponent(data, uid) {
    return p.toFile(create$4(React.createElement(App$b, { data: data }), 'bag', uid));
}
function getEquipmentComponent(data, uid) {
    return p.toFile(create$4(React.createElement(App$9, { data: data }), 'equipment', uid));
}
function getRingComponent(data, uid) {
    return p.toFile(create$4(React.createElement(App$5, { data: data }), 'ring', uid));
}
function getSkillsComponent(data, uid) {
    return p.toFile(create$4(React.createElement(App$4, { data: data }), 'skills', uid));
}
function getSkyComponent(data, uid) {
    return p.toFile(create$4(React.createElement(App$3, { data: data }), 'sky', uid));
}
...
function getJson(name) {
    return JSON.parse(readFileSync(join(dir, 'public', 'defset', `${name}.json`), 'utf-8'));
}
...
const sequelize = new Sequelize(process.env?.ALEMONJS_MYSQL_DATABASE ?? 'xiuxian', process.env?.ALEMONJS_MYSQL_USER ?? 'root', process.env?.ALEMONJS_MYSQL_PASSWORD ?? '', {
...
const user_bag = sequelize.define('user_bag', {
    id: {
...
const user_equipment = (sequelize.define('user_equipment', {
    id: {
        type: DataTypes.INTEGER,
        primaryKey: true
    },
...
const user_fate = sequelize.define('user_fate', {
    id: {
        type: DataTypes.INTEGER,
        primaryKey: true
    },
...
const user_ring = sequelize.define('user_ring', {
    id: {
        type: DataTypes.INTEGER,
        primaryKey: true
    },
...
const user_ass = sequelize.define('user_ass', {
    id: {
        type: DataTypes.INTEGER,
        primaryKey: true
    },
...
const ass_typing = sequelize.define('ass_typing', {
    id: {
        type: DataTypes.INTEGER,
        primaryKey: true
    },
...
const ass_bag = sequelize.define('ass_bag', {
    id: {
        type: DataTypes.INTEGER,
        primaryKey: true
    },
...
const map_treasure = (sequelize.define('map_treasure', {
    id: {
        type: DataTypes.INTEGER,
        primaryKey: true
    },
...
const sky = sequelize.define('sky', {
    id: {
        type: DataTypes.INTEGER,
        primaryKey: true
    },
...
const user_level = sequelize.define('user_level', {
    id: {
        type: DataTypes.INTEGER,
        primaryKey: true
    },
...
const user_blessing = (sequelize.define('user_blessing', {
    id: {
        type: DataTypes.INTEGER,
        primaryKey: true
    },
...
const user_compensate = (sequelize.define('user_compensate', {
    id: {
        type: DataTypes.INTEGER,
        primaryKey: true
    },
...
async function create$3(NAME, count) {
    ...
    if (!position)
        return;
    const mx = Math.floor(Math.random() * (position.x2 - position.x1)) +
        Number(position.x1), my = Math.floor(Math.random() * (position.y2 - position.y1)) +
        Number(position.y1), mz = Math.floor(Math.random() * (position.z2 - position.z1)) +
        Number(position.z1);
...
function set$3(UID, CDID, CDTime) {
    Redis.set(`${ReadiName}:${UID}:${CDID}`, JSON.stringify({
...
async function addExperience$1(UID, type, size, number = 5) {
    ...
    if (UserLevel.experience > 999999999)
        UserLevel.experience = 999999999;
    if (number) {
...
async function isLevelPoint(UID, type) {
    ...
    if (!data)
        return false;
    if (UserLevel.realm != data.grade)
        return false;
    if (UserLevel.experience < data.exp_needed)
        return false;
    return true;
}
...
async function updatePanel(UID, battle_blood_now) {
    ...
    panel.battle_attack = Math.floor(panel.battle_attack * (equ.attack * 0.01 + 1));
    panel.battle_defense = Math.floor(panel.battle_defense * (equ.defense * 0.01 + 1));
    panel.battle_blood_limit = Math.floor(panel.battle_blood_limit * (equ.blood * 0.01 + 1));
...
async function addBlood(BattleData, SIZE) {
    ...
    BattleData.battle_blood_now += Math.floor((BattleData.battle_blood_limit * SIZE) / 100);
...
async function personalInformation(UID, user_avatar) {
    ...
    const GaspracticeData = GaspracticeList[0], BodypracticeData = BodypracticeList[0], SoulData = SoulList[0];
...
async function equipmentInformation(UID, user_avatar) {
    ...
    if (fdata) {
        arr.push({
            ...
            critical_damage: valculateNumerical(fdata['good.critical_damage'], fdata.grade),
...
async function controlByName(e, UserData, addressName) {
    if (!(await ControlByBlood(e, UserData)))
        return false;
...
async function killNPC(e, Mname, UID, prestige) {
    if (!npcName.find(item => Mname.includes(item)))
        return true;
    e.reply(`[${Mname}]:狂妄!`);
    await update$1(UID, {
        battle_blood_now: 0
...
async function upgrade(e, UID, time, key, type, UserData) {
    ...
    let other = Math.floor((config[key] * time * (UserData.talent_size + 100)) / 100);
...
async function verify(UID) {
    const currentTime = new Date().getTime(), startTime = new Date(start_time$1).getTime(), endTime = new Date(end_time).getTime();
...
function start(UserA, UserB) {
    ...
    HurtA.outbreak = Math.floor((HurtA.original * (100 + UserA.battle_critical_damage)) / 100);
    const Aac = () => {
    ...
    HurtB.outbreak = Math.floor((HurtB.original * (100 + UserB.battle_critical_damage)) / 100);
    const Bac = () => {
...
function createExplore(i) {
    ...
    for (let j = 0; j < size; j++) {
        ...
        const acount = Math.floor(Math.random() * (cmax - cmini + 1)) + Number(cmini);
        const dmini = 1000, dmax = 9999;
...
new Worker(RedisBull, async ({ data: { UID, x, y, z, size } }) => {
...
class SkyTower extends APlugin {
    ...
    async join(e) {
        const UID = e.user_id;
        if (!(await isThereAUserPresent(e, UID)))
            return;
        if (!(await activityCooling(e, UID, '通天塔')))
            return;
        const data = (await sky.findOne({
            where: {
                uid: UID
...
class ClaimCareer extends APlugin {
    ...
    async association(e) {
        ...
        if (!(await isThereAUserPresent(e, UID)))
            return;
        const UserData = await read$7(UID);
        if (!(await controlByName(e, UserData, '协会')))
            return;
        e.reply([
            '[协会执事]😳叶子凡\n',
            '欢迎来到修仙协会\n',
...
class Auction extends APlugin {
    ...
    async sellingItems(e) {
        ...
        if (UserDataB.create_time == AuctionThing.party_b.create_time) {
            const BagSize = await backpackFull$1(AuctionThing.party_b.id, UserDataB.bag_grade);
            if (!BagSize) {
                e.reply('对方储物袋已满', {
                    quote: e.msg_id
                });
    ...
    async competition(e) {
        ...
        if (AuctionThing.party_b.id != UID ||
        ...
        if (UserDataB.create_time == AuctionThing.party_a.create_time) {
            const BagSize = await backpackFull$1(AuctionThing.party_a.id, UserDataB.bag_grade);
            if (!BagSize) {
                e.reply('物主储物袋已满');
                return;
            }
...
class Bank extends APlugin {
    ...
    async substitution(e) {
        ...
        if (!(await isThereAUserPresent(e, UID)))
            return;
        const UserData = await read$7(UID);
        if (!(await controlByName(e, UserData, '金银坊')))
            return;
...
function convertStoneQuantity(quantity, sourceStone, targetStone) {
    const sourceIndex = stones.indexOf(sourceStone), targetIndex = stones.indexOf(targetStone);
...
class Dice extends APlugin {
    ...
    async userDice(e) {
        ...
        if (!(await isThereAUserPresent(e, UID)))
            return;
        const UserData = await read$7(UID);
        if (!(await controlByName(e, UserData, '万花坊')))
            return;
        const start_msg = [];
        start_msg.push('\n[(#|/)命运转盘+物品名*数量]');
...
class Exchange extends APlugin {
    ...
    async purchase(e) {
        ...
        const BagSizeB = await backpackFull$1(exchange.party_a.id, UserDataB.bag_grade);
        if (!BagSizeB) {
            e.reply('对方储物袋已满', {
                quote: e.msg_id
            });
...
class Battle extends APlugin {
    ...
    async combat(e) {
        ...
        if (!UIDB)
            return;
        if (!(await isThereAUserPresentB(e, UIDB)))
            return;
        ...
        if (!dualVerificationAction(e, UserData.point_type, UserDataB.point_type))
            return;
        const CDID = 14, CDTime = CD_Ambiguous;
        if (!(await victoryCooling(e, UID, CDID)))
            return;
        set$3(UID, CDID, CDTime);
        const BMSG = start(UserData, UserDataB);
        ...
        const LevelDataA = await read$6(UID, 1), LevelDataB = await read$6(UIDB, 1);
        const sizeA = LevelDataA.experience * 0.15, sizeB = LevelDataB.experience * 0.1;
        const expA = sizeA > 648 ? 648 : sizeA, expB = sizeB > 648 ? 648 : sizeB;
        await update$1(UID, {
        ...
        const exA = Math.floor((expA * (UserDataB.talent_size + 100)) / 100), exB = Math.floor((expB * (UserDataB.talent_size + 100)) / 100);
        const eA = exA < 3280 ? exA : 3280, eB = exB < 3280 ? exB : 3280;
    ...
    async duel(e) {
        ...
        if (!dualVerificationAction(e, UserData.point_type, UserDataB.point_type))
            return;
        const CDID = 20, CDTime = CD_Battle;
        if (!(await victoryCooling(e, UID, CDID)))
            return;
        ...
        if (UserData.point_type == 2) {
            ...
            e.reply('[玄玉天宫]玉贞子:\n何人在此造次!');
            let thing = [];
            if (await isTrueInRange(1, 100, Math.floor(UserData.special_prestige + 50))) {
        ...
        await update$1(UID, {
            special_prestige: UserData.special_prestige,
            special_spiritual: UserData.special_spiritual - Math.floor(levelsB.realm / 2),
            battle_blood_now: BMSG.battle_blood_now.a
        });
        await update$1(UIDB, {
            battle_blood_now: BMSG.battle_blood_now.b
...
class ControllLevel extends APlugin {
    ...
    async ambiguous(e) {
        ...
        if (!dualVerificationAction(e, UserData.point_type, UserDataB.point_type))
            return;
        const CDID = 20, CDTime = CD_transmissionPower;
        if (!(await victoryCooling(e, UID, CDID)))
            return;
        set$3(UID, CDID, CDTime);
        const LevelDataA = await read$6(UID, 1), LevelDataB = await read$6(UIDB, 1);
        ...
        const exA = Math.floor((expA * (UserData.talent_size + 100)) / 100), exB = Math.floor((expB * (UserDataB.talent_size + 100)) / 100);
        const eA = exA < 3280 ? exA : 3280, eB = exB < 3280 ? exB : 3280;
    ...
    async transmissionPower(e) {
        ...
        const LevelSize = 9;
        if (LevelDataB.realm < LevelDataA.realm - LevelSize ||
            ...
            if (UserData.battle_blood_now > 0) {
                {
                    ...
                    await user_level.update({ realm: 42 }, { where: { uid: UID, type: 1 } });
                    clearInterval(time);
                }
            }
            else {
...
async function levelUp(e, CDID, ID, p) {
    ...
    if (!isTrueInRange(1, 100, p - LevelMsg.realm + number)) {
        ...
        const msg = await getCopywriting(ID, randomKey, size > 999999 ? 999999 : size);
        e.reply([msg], {
            quote: e.msg_id
        });
        return;
...
class Monster extends APlugin {
    ...
    async userKill(e) {
        ...
        if (!killNPC(e, Mname, UID, UserData.special_prestige))
            return;
        ...
        const BMSG = start(UserData, {
            ...
            name: Mname,
            battle_show: 0,
            battle_blood_now: Math.floor(LevelMax.blood * ((mon.level + 1) * 0.01 + 1)),
            battle_attack: Math.floor(LevelMax.attack * ((mon.level + 1) * 0.05 + 1)),
            battle_defense: Math.floor(LevelMax.defense * ((mon.level + 1) * 0.01 + 1)),
            battle_blood_limit: Math.floor(LevelMax.blood * ((mon.level + 1) * 0.01 + 1)),
        ...
        if (BMSG.victory == '0') {
            ...
            let thing = [];
            if (await isTrueInRange(1, 100, Math.floor(UserData.special_prestige + 10))) {
                thing = await delThing(UID);
            }
            if (thing.length != 0) {
                e.reply([`[${Mname}]击碎了你的[${thing[0]?.name}]\n你重伤倒地,奄奄一息~`], {
                    quote: e.msg_id
                });
                return;
            }
    ...
    async userExploremonsters(e) {
        ...
        const name = await getPlaceName(UserData.point_type, UserData.pont_attribute);
        ...
        const sortedMonsters = Object.keys(monster).sort((a, b) => monster[a].level - monster[b].level);
    ...
    async demontower(e) {
        ...
        if (!(await controlByName(e, UserData, '星海')))
            return;
        if (!(await ControlByBlood(e, UserData)))
            return;
        const BagSize = await backpackFull$1(UID, UserData.bag_grade);
        ...
        if (BMSG.victory == '0') {
            ...
            if (p < 25) {
                ...
                return e.reply('虽然你勇敢地战胜了守塔的守卫,但这次战斗似乎没有找到任何物品');
            }
            else if (p > 50 && p <= 100) {
...
class Ore extends APlugin {
    ...
    async gather(e) {
        ...
        const gaspractice = await read$6(UID, 1).then(item => item.realm);
        const acount = Number(size == '' || size == undefined || gaspractice < 25 || Number(size) > 2
            ? 1
            : size);
        ...
        if (!(await victoryCooling(e, UID, CDID)))
            return;
        if (!killNPC(e, id, UID, UserData.special_prestige))
            return;
...
class Bag extends APlugin {
    ...
    async showBagType(e) {
        ...
        const img = await getBagComponent(await backpackInformation(e.user_id, e.user_avatar, mapType[type] ?? mapType['道具']), UID);
        if (typeof img != 'boolean')
            e.reply(img);
        return;
    }
...
class MoneyOperation extends APlugin {
    ...
    async giveMoney(e) {
        ...
        const CDID = 5, CDTime = CD_Transfer;
        if (!(await victoryCooling(e, UID, CDID)))
            return;
        set$3(UID, CDID, CDTime);
        await reduceBagThing(UID, [
...
class Ring extends APlugin {
    ...
    async showRing(e) {
        ...
        if (!(await isThereAUserPresent(e, UID)))
            return;
        const img = await getRingComponent(await ringInformation(UID, e.user_avatar), UID);
        if (typeof img != 'boolean')
            e.reply(img);
        return;
    }
...
class Help extends APlugin {
    ...
    async getBaseHelp(e) {
        if (e.platform == 'ntqq') {
            Controllers(e).Message.reply('按钮', [
...
class Action extends APlugin {
    ...
    async take(e) {
        ...
        switch (thing.addition) {
            ...
            case 'exp_gaspractice': {
                ...
                const size = Math.floor((Number(thingAcount) *
    ...
    async consumption(e) {
        ...
        switch (thing.id) {
            case 600201: {
                addExperience(e, UID, 12, UserData.talent_size, {
                    name: thing.name,
            ...
            case 600202: {
                addExperience(e, UID, 20, UserData.talent_size, {
                    name: thing.name,
                    experience: thing.exp_gaspractice
                }, Number(thingAcount));
                break;
            ...
            case 600203: {
                addExperience(e, UID, 28, UserData.talent_size, {
                    name: thing.name,
                    experience: thing.exp_gaspractice
                }, Number(thingAcount));
                break;
            ...
            case 600204: {
                addExperience(e, UID, 36, UserData.talent_size, {
                    name: thing.name,
                    experience: thing.exp_gaspractice
                }, Number(thingAcount));
                break;
            ...
            case 600402: {
                ...
                for await (const item of PositionData) {
                    const x = (item?.x1 + item?.x2) / 2, y = (item?.y1 + item?.y2) / 2, z = (item?.z1 + item?.z1) / 2;
                    const distance = Math.sqrt(Math.pow(x - UserData.pont_x, 2) +
...
async function addExperience(e, UID, grade, talentsize, thing, acount) {
    ...
    const size = Math.floor((acount * thing.experience * (talentsize + 100)) / 100 / dividend);
    await reduceBagThing(UID, [
        {
            name: thing.name,
            acount: acount
...
async function sendLing(e, UID, acount) {
    ...
    const CDID = 12, CDTime = CD_Pconst_ractice;
    if (!(await victoryCooling(e, UID, CDID)))
        return false;
    set$3(UID, CDID, CDTime);
    const LevelData = await read$6(UID, 1);
...
class Destiny extends APlugin {
    ...
    async refine(e) {
        ...
        const exp_bodypractice = await read$6(UID, 2).then(res => res.experience);
        const exp_soul = await read$6(UID, 3).then(res => res.experience);
        if (exp_gaspractice < udata.exp_gaspractice ||
...
async function showAction(e, UID, UserData) {
    const mData = await getRecordsByXYZ(UserData.pont_x, UserData.pont_y, UserData.pont_z);
    if (mData) {
        await update$1(UID, {
            point_type: mData.type,
            pont_attribute: mData.attribute,
...
class Secretplace extends APlugin {
    ...
    async forward(e) {
        ...
        const { hours, minutes, seconds, totalMilliseconds } = estimateTotalExecutionTime(UserData.pont_x, UserData.pont_y, point.x, point.y, size, time);
    ...
    async delivery(e) {
        ...
        await set$1(UID, setTimeout(async () => {
            await del$7(UID);
            await update$1(UID, {
                pont_x: mx,
                pont_y: my,
...
class Tianjigate extends APlugin {
    ...
    async serchIf(e) {
        ...
        if (!(await isThereAUserPresent(e, UID)))
            return;
        const UserData = await read$7(UID);
        if (!(await controlByName(e, UserData, '天机门')))
            return;
...
class Modify extends APlugin {
    ...
    async changeAutograph(e) {
        ...
        const CDID = 4, CDTime = CD_Autograph;
        if (!(await victoryCooling(e, UID, CDID)))
            return;
        set$3(UID, CDID, CDTime);
        await update$1(UID, {
...
class Transaction extends APlugin {
    ...
    async showComodities(e) {
        ...
        if (!(await isThereAUserPresent(e, UID)))
            return;
        const UserData = await read$7(UID);
        if (!(await controlByName(e, UserData, '万宝楼')))
            return;
        const start_msg = [];
        start_msg.push('\n欢迎关顾本店');
    ...
    async sellComodities(e) {
        ...
        const commoditiesPrice = Math.floor(thing.price * Number(quantity) * ExchangeEnd);
        await addBagThing(UID, UserData.bag_grade, [
            {
                name: '下品灵石',
...
class union extends APlugin {
    ...
    async unionShop(e) {
        ...
        if (!(await isThereAUserPresent(e, UID)))
            return;
        const UserData = await read$7(UID);
        if (!(await controlByName(e, UserData, '联盟')))
            return;
        const start_msg = [];
        start_msg.push('\n[(#|/)兑换+物品名*数量]');
    ...
    async userSignIn(e) {
        ...
        const bodypractice = await read$6(UID, 2).then(item => item.realm);
        const soul = await read$6(UID, 3).then(item => item.realm);
        if (gaspractice < sky.gaspractice ||
    ...
    async exchange(e) {
        ...
        if (!(await isThereAUserPresent(e, UID)))
            return;
        if (!(Date.now() >= new Date('2024-04-08').getTime() &&
...
class Admins extends APlugin {
    ...
    async switch(e) {
        ...
        await user_skills.update({ uid: switchuid + '-1' }, { where: { uid: switchuid } });
